    ...
    <div className="flex flex-col items-center justify-center text-center space-y-8 animate-fadeIn h-full">
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full max-w-2xl">
        <button
          ...
          className="flex-1 bg-white border-2 border-teal-200 p-8 rounded-3xl hover:border-teal-600 hover:bg-teal-50 transition-all group shadow-sm hover:shadow-md"
        >
          <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-teal-700">Recent 5 Letters</h3>
        ...
        <button
          ...
          className="flex-1 bg-white border-2 border-teal-200 p-8 rounded-3xl hover:border-teal-600 hover:bg-teal-50 transition-all group shadow-sm hover:shadow-md"
        >
          <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-teal-700">Mix All 10</h3>
