  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-10 animate-fadeIn h-full py-12 px-6">
      <div className="relative scale-125 mb-4">
        ...
        <PartyPopper className="w-12 h-12 text-teal-600 absolute -top-6 -right-6 animate-bounce" />
      </div>

      <div className="space-y-4">
        <h2 className="text-6xl font-black text-slate-800 tracking-tighter">Alf Mabrouk!</h2>
        <div className="bg-teal-700 text-white px-6 py-2 rounded-full inline-block font-black text-xl uppercase tracking-widest animate-fadeIn delay-500">
      ...
      <div className="flex flex-col items-center space-y-4">
        <button
          ...
          className="group flex items-center space-x-3 bg-teal-700 text-white px-10 py-4 rounded-2xl text-xl font-black hover:bg-teal-800 transition-all shadow-xl transform hover:scale-105 active:scale-95"
        >
