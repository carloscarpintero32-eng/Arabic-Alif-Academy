...
export const ALPHABET_DATA: ArabicLetter[] = [
  {
    ...
    examples: {
      ...
      medial: { prefix: 'رـ', letter: 'ـأ', suffix: 'س', translation: 'Head' },
  ...
  },
  {
    ...
    examples: {
      ...
      final: { prefix: 'بحـ', letter: 'ـث', suffix: '', translation: 'Research' }
    }
  },
  {
  ...
  },
  {
    ...
    examples: {
      ...
      final: { prefix: 'بلـ', letter: 'ـد', suffix: '', translation: 'Country' }
    }
  },
  {
